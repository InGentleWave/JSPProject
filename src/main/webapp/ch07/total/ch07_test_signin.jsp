                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<form method="post" action="./ch07_test_signin_process.jsp">
							<div class="mb-3 row" id="alertDiv" style="background-color : lightgreen;">
								<p class="alertMsg">회원가입 되었습니다.</p>
							</div>
							아이디 : <input type="text" name="" class="form-control"/> <br/>
							비밀번호 : <input type="text" name="" class="form-control"/> <br/>
