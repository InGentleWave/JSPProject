                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<form action="" method="post">
							...
							연락처 : 	<input type="text" name="phone1" maxlength="3" size="3"/> -
							...
							취미 :	<input type="checkbox" name="hobby1" checked="checked"/>독서&nbsp;
									<input type="checkbox" name="hobby2" checked="checked"/>운동&nbsp;
									<input type="checkbox" name="hobby3" checked="checked"/>영화&nbsp;
